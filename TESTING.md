...
**HTML:**
```html
<p>Это <b>жирный текст</b>, это <i>курсив</i>, это <u>подчеркнутый</u>.</p>
<p>Комбинация: <b><i>жирный курсив</i></b></p>
```

**Ожидаемый вывод (plain):**
```
Это жирный текст, это курсив, это подчеркнутый.

Комбинация: жирный курсив
```
...
**Ожидаемый вывод (markdown):**
```markdown
Это **жирный текст**, это *курсив*, это <u>подчеркнутый</u>.
...
**HTML:**
```html
<p>Текст с<br><br>переносом строки внутри<br><br>Текст в div с<br><br>двумя переносами</p>
```
